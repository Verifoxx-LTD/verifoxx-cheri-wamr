 ...
 */
 ...
 // Standalone advanced file test for WASI-libC using standard library functions
 // ref WAMR test case

 /* Build with clang --target=wasm32-unknown-wasi -o wasi_advanced_file.wasm wasi_advanced_file.c */
