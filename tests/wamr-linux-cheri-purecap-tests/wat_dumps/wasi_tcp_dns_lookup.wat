(module
  ...
  (import "wasi_snapshot_preview1" "sock_addr_resolve" (func $__imported_wasi_snapshot_preview1_sock_addr_resolve (type 4)))
  (import "wasi_snapshot_preview1" "sock_set_recv_timeout" (func $__imported_wasi_snapshot_preview1_sock_set_recv_timeout (type 5)))
  (import "wasi_snapshot_preview1" "sock_set_send_timeout" (func $__imported_wasi_snapshot_preview1_sock_set_send_timeout (type 5)))
  ...
  (import "wasi_snapshot_preview1" "sock_recv" (func $__imported_wasi_snapshot_preview1_sock_recv (type 4)))
  ...
  (func $main (type 2) (param i32 i32) (result i32)
    ...
    block  ;; label = @1
      ...
      local.get 4
      local.get 73
      i32.store16 offset=4130
      i32.const 1
      local.set 74
      local.get 4
      local.get 74
      i32.store16 offset=4128
      local.get 4
      i32.load offset=28
      local.set 75
      i32.const 4128
    ...
    local.get 119
    return)
  (func $lookup_host (type 2) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i64 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i64 i32 i32 i32 i64 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 2
    i32.const 1104
    local.set 3
    ...
    local.get 74
    return)
  (func $do_send (type 2) (param i32 i32) (result i32)
    ...
    local.get 35
    return)
  (func $do_receive (type 0) (param i32 i32 i32) (result i32)
  ...
  (func $__wasi_sock_open (type 3) (param i32 i32 i32 i32) (result i32)
    ...
    local.get 13
    return)
  (func $getaddrinfo (type 3) (param i32 i32 i32 i32) (result i32)
    ...
    local.get 9
    local.get 12
    call $addrinfo_hints_to_wasi_hints
    local.set 13
    local.get 6
    local.get 13
    i32.store16 offset=14
    ...
    block  ;; label = @1
      ...
      block  ;; label = @2
        loop  ;; label = @3
          ...
          local.get 135
          local.get 136
          call $wasi_addr_info_to_addr_info
          local.set 137
          local.get 6
          local.get 137
          i32.store16 offset=14
    ...
    local.get 176
    return)
  (func $addrinfo_hints_to_wasi_hints (type 2) (param i32 i32) (result i32)
    ...
    local.get 44
    return)
  (func $__wasi_sock_addr_resolve (type 4) (param i32 i32 i32 i32 i32 i32) (result i32)
    ...
    local.get 13
    local.get 14
    call $__imported_wasi_snapshot_preview1_sock_addr_resolve
    local.set 15
    i32.const 65535
    local.set 16
    local.get 15
    ...
    local.get 17
    return)
  (func $wasi_addr_info_to_addr_info (type 2) (param i32 i32) (result i32)
  ...
  (func $timeval_to_time_us (type 12) (param i32) (result i64)
    ...
    local.get 5
    return)
  (func $__wasi_sock_set_recv_timeout (type 5) (param i32 i64) (result i32)
    ...
    local.get 9
    return)
  (func $__wasi_sock_set_send_timeout (type 5) (param i32 i64) (result i32)
    (local i32 i32 i32 i32 i64 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 2
    i32.const 16
  ...
  (func $dlmalloc (type 6) (param i32) (result i32)
    ...
    block  ;; label = @1
      ...
      block  ;; label = @2
        ...
        i32.const 0
        i64.const -1
        i64.store offset=5076 align=4
        i32.const 0
        i64.const 281474976776192
        i64.store offset=5068 align=4
        i32.const 0
        local.get 1
        i32.const 8
        i32.add
              ...
              block  ;; label = @6
                block  ;; label = @7
                  block  ;; label = @8
                    ...
                    i32.add
                    i32.const 0
                    i64.load offset=5048 align=4
                    i64.store align=4
                    local.get 8
                    i32.const 0
                    i64.load offset=5040 align=4
  ...
  (func $__wasi_proc_exit (type 8) (param i32)
    ...
    unreachable)
  (func $__wasi_sock_recv (type 4) (param i32 i32 i32 i32 i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
  ...
  (func $__wasi_sock_send (type 9) (param i32 i32 i32 i32 i32) (result i32)
    ...
    i32.const 65535
    i32.and)
  (func $htonl (type 6) (param i32) (result i32)
    local.get 0
    i32.const 24
    i32.shl
    local.get 0
    ...
    i32.or
    i32.or)
  (func $htons (type 6) (param i32) (result i32)
    local.get 0
    i32.const 8
    i32.shl
    local.get 0
    ...
    i32.const 65535
    i32.and)
  (func $ntohl (type 6) (param i32) (result i32)
    local.get 0
    i32.const 24
    i32.shl
    local.get 0
    ...
    i32.or
    i32.or)
  (func $ntohs (type 6) (param i32) (result i32)
    local.get 0
    i32.const 8
    i32.shl
    local.get 0
    ...
    i32.const 65535
    i32.and)
  (func $inet_ntop (type 3) (param i32 i32 i32 i32) (result i32)
  ...
  (func $__assert_fail (type 15) (param i32 i32 i32 i32)
    ...
    call $abort
    unreachable)
  (func $snprintf (type 3) (param i32 i32 i32 i32) (result i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $printf (type 2) (param i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 1)
  (func $vsnprintf (type 3) (param i32 i32 i32 i32) (result i32)
    (local i32 i32)
    global.get $__stack_pointer
    i32.const 128
    i32.sub
  ...
  (func $memset (type 0) (param i32 i32 i32) (result i32)
    ...
    local.get 0)
  (func $strspn (type 2) (param i32 i32) (result i32)
    (local i32 i32 i32 i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (data $.rodata (i32.const 1024) "-+   0X0x\00-0X+0X 0X-0x+0x 0x\00%x:%x:%x:%x:%x:%x:%x:%x\00Failed convert to IP address\00Host lookup fails\00sockaddr_to_wasi_addr\00set_sol_socket_option\00set_ipproto_ip_option\00set_ipproto_tcp_option\00set_ipproto_ipv6_option\00sizeof(struct sockaddr_in) <= addrlen\00sizeof(struct sockaddr_in6) <= addrlen\00nan\00inf\00Create socket failed\00Client Connect failed\00Set socket options failed\00Receive failed\00Send failed\00%x:%x:%x:%x:%x:%x:%d.%d.%d.%d\00wasi_socket_ext.c\00NAN\00INF\00Test FAILED\00:0\00.\00optlen == sizeof(int)\00optlen == sizeof(uint32_t)\00optlen == sizeof(struct linger)\00optlen == sizeof(struct ip_mreq)\00optlen == sizeof(struct ipv6_mreq)\00(null)\00optlen == sizeof(struct timeval)\00Host lookup succeeds\0a\00Host: %s -> IP Addr: %s\0a\00Received page:\0a%s\0a\00Receiving test message\0a\00Sending test message\0a\00Connected\0a\00Sent %d bytes of test data OK\0a\00Received %d bytes of test data OK\0a\00Usage: %s <domain_name>\0a\00Support for formatting long double values is currently disabled.\0aTo enable it, add -lc-printscan-long-double to the link command.\0a\00Assertion failed: %s (%s: %s: %d)\0a\00Sent \22%s\22\0a\00Test succeeds!\0a\00Peer disconnected!\0a\00Lookup host failed!\0a\00Finished!\0a\00GET /\0d\0a\00\00\00\00\00\00\00\00\00\00\00\ff\ff\00Success\00Illegal byte sequence\00Domain error\00Result not representable\00Not a tty\00Permission denied\00Operation not permitted\00No such file or directory\00No such process\00File exists\00Value too large for data type\00No space left on device\00Out of memory\00Resource busy\00Interrupted system call\00Resource temporarily unavailable