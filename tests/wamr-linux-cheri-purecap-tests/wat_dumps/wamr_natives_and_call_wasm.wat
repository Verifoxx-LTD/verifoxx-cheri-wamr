(module
  ...
  (import "env" "do_sum_ex" (func $do_sum_ex (type 0)))
  (import "env" "do_sum_many_args" (func $do_sum_many_args (type 2)))
  (import "env" "print_something_ex" (func $print_something_ex (type 3)))
  ...
  (func $__original_main (type 10) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i64 i64 i32 i32 i32 i32 i32 i32)
    ...
    local.get 35
    return)
  (func $print_in_wasm (type 4) (param i32) (result i32)
    ...
    local.get 7
    return)
  (func $subtract_in_wasm (type 11) (param i32 i32) (result i64)
