...
if (NOT WAMR_BUILD_AOT EQUAL 1 AND DEFINED WAMR_BUILD_AOT_CHERI_PTR AND WAMR_BUILD_AOT_CHERI_PTR GREATER 0)
  message (FATAL_ERROR "-- WAMR_BUILD_AOT_CHERI_PTR requires WAMR_BUILD_AOT")
endif ()
...
if (DEFINED WAMR_BUILD_AOT_CHERI_PTR AND WAMR_BUILD_AOT_CHERI_PTR GREATER 0)
  message ("     WAMR AOT build for CHERI - pointer size=${WAMR_BUILD_AOT_CHERI_PTR}")
endif ()
if (WAMR_BUILD_FAST_JIT EQUAL 1)
...
if (WAMR_BUILD_CHERI_PERF_PROFILING EQUAL 1)
  add_definitions (-DWASM_ENABLE_CHERI_PERF_PROFILING=1)
  message ("     CHERI Perf profiling extension enabled")
endif ()
elseif (WAMR_BUILD_CHERI_PERF_PROFILING EQUAL 1)
  message (FATAL_ERROR "WAMR_BUILD_CHERI_PERF_PROFILING requires WAMR_BUILD_PERF_PROFILING to also be set")
endif ()
...
if (WAMR_BUILD_DEBUG_PREPROCESSOR EQUAL 1)
    message ("     Debug Preprocessor enabled")
    if (WAMR_BUILD_FAST_INTERP EQUAL 1)
        message(WARNING "*** NOTE Fast Interpreter enabled with debug proprocessor ***")
    endif ()
endif()
